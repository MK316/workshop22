...
| :date: Schedule | Topics | Contents | <div style="width:400px">Github pages</div>| Data files | Video material |
|----------|--------|------|--------|------------|-----------|
...
| **Session 4** | Coding-app assisted language classes | Assisting language teaching / learning | ↗️  links |     |   |
