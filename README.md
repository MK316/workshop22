...
| **Session 2** | NLP: Frequency, LD, Concordance, N-gram, POS tagging, etc. | Text data analysis, Getting linguistic information from big data |  links |  |   |
| **Session 3** | Data visualization & basic stats | Basic plotting & descriptive statistics | [session03](/session03.ipynb) |  |  |
